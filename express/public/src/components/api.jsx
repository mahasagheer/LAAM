...
export default function api() {
  ...
  return (
    <>
      <h1 className=" xs:text-2xl  md:text-4xl">TOP TRENDING</h1>
      <section>
          ...
          {data &&
            data.map((p) => {
              return (
                <div
                  key={p.id}
                  className="flex flex-col px-2 xl:w-1/4 lg:w-1/4 md:w-1/3 sm:w-2/4 sm:px-2 xs:w-2/4 xs:pl-8"
                >
                  ...
                  <div className="flex pl-1 flex-row mb-8 md:w-3/12 text-sm items-center gap-1 rounded bg-sky-200 xs:w-5/12	">
                    {" "}
